...
public class Constants
{
    ...
    // Valid board values
    public static final int R = -1;    // Indicates an "R"
    public static final int B = 1;     // Indicates an "B"
    ...
    public static final String INVALID_ROW_OR_COLUMN = "Column must be 1, 2, 3, 4, 5, 6, or 7";
